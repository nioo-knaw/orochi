...
with open("config.json", "w") as file:
    ...
    file.write('    ' + '   ' + '"all" : ' + str(main_name_list) + '\n')
    file.write('     ' + x_1.format("") + "," + '\n')
    file.write('     ' + data_line + x_0.format("") + '\n')



## This is for print the data (samples)
...
with open("config.json", "a") as file:
    file.write('     ' + x_1.format("") + '\n')
    file.write(x_1.format("") + '\n')
    print("Configuration file successfully created. Chosen assembly mode: co-assembly")
