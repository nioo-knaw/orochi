...
file_path = 'clustering/table_madeUp.txt'
...
plt.savefig('clustering/dendrogram.png', dpi=300, bbox_inches='tight')
...
if k == 0:
    ...
    plt.savefig('clustering/silhouette_score.png', dpi=300, bbox_inches='tight')
    plt.show()
...
print("'samples.tsv' file successfully changed.")