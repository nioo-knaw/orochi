...
quality_files <- list.files("rsc", pattern = "\\.html$", full.names = TRUE)
#quality_files <- list.files(file.path(outdir, "results/08_plots/rsc"), pattern = "\\.html$", 
 #                           full.names = TRUE, recursive = TRUE)

# Start a two-column container and loop through files
