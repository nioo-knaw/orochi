...
Columns correspond to samples, rows correspond to the labels found in the currently displayed taxonomic level. You can naviagte each level by clicking the buttons underneath.
...
{Description from MicrobiotaProcess}
...
PCoA ___. Colors correspond to treatments, and boxplots on the right and top side indicate the distribution of each treatment along each coordinate. 95% confidence interval is also plotted.
...
You can find more data about your bins in OUTDIR/results/... ###########
...
(From left to right) Relation between 16S sequences, contigs from the assembly (indicated at the top of the plot), and refined bins.
The size of the fragment indicates ____, and the color of the 
You can find more about this process in {WEBSITE FROM MARKERMAG AND PHYLOFLASH?}
