...
Usage:
    python fastqCombinePairedEnd.py input1 input2 output1 output2 outputS separator

input1 = LEFT  fastq or fastq.gz file (R1)
input2 = RIGHT fastq or fastq.gz file (R2)
output1 = LEFT  fastq or fastq.gz file (R1)
output2 = RIGHT fastq or fastq.gz file (R2)
outputS = Singular reads freom either R1 or R2
...
if __name__ == "__main__":
    ...
    with myopen(xout1, "w") as out1:
        with myopen(xout2, "w") as out2:
            with myopen(sout, "w") as out3:
