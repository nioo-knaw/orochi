...
rule coverm_sample:
    input:
        contigs="scratch/assembly/{assembler}/{treatment}/{kmers}/assembly.fa", 
        forward = expand("scratch/assembly/{assembler}/{treatment}/{kmers}/{sample}_forward.fastq", sample=config["data"]),
        reverse = expand("scratch/assembly/{assembler}/{treatment}/{kmers}/{sample}_reverse.fastq", sample=config["data"]),
        index="scratch/assembly/{assembler}/{treatment}/{kmers}/assembly.fa.bwt"
    output:
